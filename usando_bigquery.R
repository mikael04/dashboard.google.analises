...
df_filtros = tbl(con,"hml_base_filtro") #conexão com essa tabela, da para selecionar ou filtra direto com dplyr
teste = df_filtros %>% collect() # download para dataframe

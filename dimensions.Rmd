...
df_dimensions %>%
  dplyr::order_by(metrics.times_cited)
```
...
library(rgdal)
world_spdf <- readOGR( 
  dsn= paste0(getwd(),"dados/world_shape_file/") , 
...
count_vazio = sum(stringr::str_detect(df_dimensions_fund_org$raw_affiliations, "vazio"))

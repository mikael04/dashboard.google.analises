...
df_count_base_plus_categ_filtered <- data.table::fread("../dados/app/first_plots/df_mod_categ_pub_first_plot.csv")
    ...
    output$plotly <- plotly::renderPlotly({
        ...
        plotly::ggplotly(p, tooltip = c("text")) |>
            ...
            plotly::layout(title = list(text='Publicações por Categoria (ANZSRC)',
                                        xanchor = 'right', yanchor =  'auto', pad = list(b = 90, l = 130, r = 50 )))
    })
}
